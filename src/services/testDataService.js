 ...
 */
export function generateTestWeek() {
    ...
    for (let dayOffset = 0; dayOffset < 8; dayOffset++) { // 0 à 7 = dimanche à dimanche
        ...
        dayCourses.forEach(course => {
            ...
            console.log(`[Test Week] ${currentDate.toLocaleDateString('fr-FR', {weekday: 'long'})} : ${course.subject} de ${startTime.toLocaleTimeString('fr-FR', {hour: '2-digit', minute: '2-digit'})} à ${endTime.toLocaleTimeString('fr-FR', {hour: '2-digit', minute: '2-digit'})}`);
    ...
    // Trier par date
    testEvents.sort((a, b) => new Date(a.start) - new Date(b.start));
 ...
 */
export function isTestWeekEnabled() {
 ...
 */
export function setTestWeekMode(enabled) {
